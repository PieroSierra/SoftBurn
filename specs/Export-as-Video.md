# SPEC: Export as Video (Slideshow App)
...
The current "Save slideshow" icon ("square.and.arrow.down") needs to become menu called File (with just an icon = "Doc").  Inside that menu will be 2 choices:  "Save Slideshow..." (icon
= "square.and.arrow.down") that works just as before; and "Export as Video" (icon = "film.stack") which when clicked opens up a menu with "QuickTime (720p)..." and "QuickTime (480p)..."
