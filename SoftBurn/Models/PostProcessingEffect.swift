...
struct PostProcessingEffectModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        ...
        // Wes Color Palettes - GPU shader-based grading
        // These effects are applied in the Metal shader (SlideshowShaders.metal)
        // SwiftUI view modifier passes through unchanged
        case .budapestRose, .fantasticMrYellow, .darjeelingMint:
            content
        }
    }
}
